...
// RestoreObjectDetailV2 support more features than RestoreObject
func (bucket Bucket) RestoreObjectDetailV2(objectKey, configXML string, options ...Option) error {
	buffer := new(bytes.Buffer)
